...
# teaches the model
curl -X POST -H "Content-Type: application/json" -d @neutral.json http://localhost:8080/classificationbox/models/model1/teach-multi
curl -X POST -H "Content-Type: application/json" -d @biased.json http://localhost:8080/classificationbox/models/model1/teach-multi
curl -X POST -H "Content-Type: application/json" -d @satire.json http://localhost:8080/classificationbox/models/model1/teach-multi
